...
func (pa *OcpProblemAPI) DescribeProblemV1(_ context.Context, problemQuery *desc.ProblemQueryV1) (*desc.ProblemV1, error) {
	problem, err := pa.repo.DescribeEntity(problemQuery.Id)
	if err != nil {
