...
func (m *MockRepo) AddEntities(arg0 []utils.Problem) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 uint64) (*utils.Problem, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0, arg1 uint64) ([]utils.Problem, error) {
	m.ctrl.T.Helper()
