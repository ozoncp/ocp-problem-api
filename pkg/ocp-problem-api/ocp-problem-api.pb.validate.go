...
// Validate checks the field values on ListResultSaveV1 with the rules defined
// in the proto definition for this message. If any rules are violated, an
// error is returned.
func (m *ListResultSaveV1) Validate() error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetList() {
		...
		if v, ok := interface{}(item).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return ListResultSaveV1ValidationError{
...
// ListResultSaveV1ValidationError is the validation error returned by
// ListResultSaveV1.Validate if the designated constraints aren't met.
type ListResultSaveV1ValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListResultSaveV1ValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListResultSaveV1ValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListResultSaveV1ValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListResultSaveV1ValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListResultSaveV1ValidationError) ErrorName() string { return "ListResultSaveV1ValidationError" }

// Error satisfies the builtin error interface
func (e ListResultSaveV1ValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListResultSaveV1.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListResultSaveV1ValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListResultSaveV1ValidationError{}
